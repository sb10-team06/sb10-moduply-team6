...
class ExternalContentManualImportServiceTest {
  ...
  @Test
  @DisplayName("TMDB 영화 수동 수집 시 TMDB Client 호출 후 외부 콘텐츠 저장 서비스를 호출한다.")
  ...
  void importTmdbTvSeries_success_with_client_response() {
    ...
    // When
    ExternalContentImportResult result = externalContentManualImportService.importTmdbTvSeries(1, "ko-KR");
  ...
  @Test
  @DisplayName("The Sports DB 리그 경기 수동 수집 시 저장 서비스를 호출한다.")
  ...
  @Test
  @DisplayName("The Sports DB 일별 경기 수동 수집 시 저장 서비스를 호출한다.")
